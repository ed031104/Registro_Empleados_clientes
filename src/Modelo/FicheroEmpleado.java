...
public class FicheroEmpleado{    
    ...
    protected void crearFichero(Empleados empleado) {
    ...
    public ArrayList<Empleados> extraerDatosFacturaFicheros() throws IOException, ParseException{
    ...
    while ((linea = br.readLine()) != null) {
        ...
        if (dato.length == 169) {
            ...
            String candidato = dato[168].trim();
                    ...
                    Empleados emple = new Empleados(puestosolicitado, descripcionpuesto, fechasolicitudempleo, sueldomensualdeseado, sueldomensualautorizado, estatura, peso, domicilio, 
                            colonia, telefono, municipio, lugardenacimiento, sexo, operadortelefono, email, fechadenacimiento, edad, codigopostal, registrooperacioncontribuyentes, 
                            claveunicaregistropoblacion, numeroseguridadsocial, afore, numeropasaporte, cartillamilitar, licenciamanejo, numerolicencia, documentacionextranjerolaboral, 
                            saludactual, enfermedadcronica, clubsocial, deporte, pasatiempo, metavida, nombrepadre, vivepadre, finadopadre, domiciliopadre, ocupacionpadre, nombremadre, 
                            vivemadre, finadomadre, domiciliomadre, ocupacionmadre, nombreconyugue, viveconyugue, finadoconyugue, domicilioconyugue, ocupacionconyugue, nombreescuelaprimaria, 
                            domicilioescuelaprimaria, fechainicioescuelaprimaria, fechafinalescuelaprimaria, añoscursadosescuelaprimaria, tituloescuelaprimaria, nombreescuelasecundaria, domicilioescuelasecundaria,
                            fechainicioescuelasecundaria, fechafinalescuelasecundaria, Añoscursadosescuelasecundaria, tituloescuelasecundaria, nombreescuelapreparatoria, domicilioescuelapreparatoria, fechainicioescuelapreparatoria,
                            fechafinalescuelapreparatoria, añoscursadosescuelapreparatoria, tituloescuelapreparatoria, nombreescuelacomercial, domicilioescuelacomercial, fechainicioescuelacomercial, fechafinalescuelacomercial, 
                            añoscursadosescuelacomercial, tituloescuelacomercial, nombreescuelaactual, horarioescuelaactual, carreraescuelaactual, gradoescuelaactual, idiomasextranjeros, funcionesoficina, maquinasoficinamanejo, 
                            softwaredomina, otrasfuncionesdomina, prestoserviciosempleoactualdesde, prestoserviciosempleoactualhasta, nombrecompañiaempleoactual, domicilioempleoactual, telefonoempleoactual, puestodesempeñoempleoactual, 
                            sueldoinicialempleoactual, sueldofinalempleoactual, motivoseparacionempleoactual, nombrejefedirectoempleoactual, puestojefedirectoempleoactual, motivoseparacionempleoactualsi, motivoseparacionempleoactualno,
                            prestoservicioempleoanterior1desde, prestoserviciosempleoanterior1hasta, nombrecompañiaempleoanterior1, domicilioempleoanterior1, telefonoempleoanterior1, puestodesempeñoempleoanterio1, sueldoinicialempleoanterior1, 
                            sueldofinalempleoanterior1, motivoseparacionempleoanterior1, nombrejefedirectoempleoanterior1, puestojefedirectoempleoanterior1, motivoseparacionempleoanterior1si, motivoseparacionempleoanterior1no, prestoservicioempleoanterior2desde,
                            prestoserviciosempleoanterior2hasta, nombrecompañiaempleoanterior2, domicilioempleoanterior2, telefonoempleoanterior2, puestodesempeñoempleoanterio2, sueldoinicialempleoanterior2, sueldofinalempleoanterior2, 
                            motivoseparacionempleoanterior2, nombrejefedirectoempleoanterior2, puestojefedirectoempleoanterior2, motivoseparacionempleoanterior2si, motivoseparacionempleoanterior2no, prestoservicioempleoanterior3desde, 
                            prestoserviciosempleoanterior3hasta, nombrecompañiaempleoanterior3, domicilioempleoanterior3, telefonoempleoanterior3, puestodesempeñoempleoanterio3, sueldoinicialempleoanterior3, sueldofinalempleoanterior3,
                            motivoseparacionempleoanterior3, nombrejefedirectoempleoanterior3, puestojefedirectoempleoanterior3, motivoseparacionempleoanterior3si, motivoseparacionempleoanterior3no, referencianombre, referenciatelefono, 
                            referenciadomicilio, referenciaocupacion, referenciatiempoconocerse, referencianombre2, referenciatelefono2, referenciadomicilio2, referenciaocupacion2, referenciatiempoconocerse2, referencianombre3, 
                            referenciatelefono3, referenciadomicilio3, referenciaocupacion3, referenciatiempoconocerse3, referencianombre4, referenciatelefono4, referenciadomicilio4, referenciaocupacion4, referenciatiempoconocerse4, 
                            saberemppleootros, fachaunir, otrosingresos, importemensual, conyuguetrabaja, percepcionmensual, valoraproximano, importe, importemensual, abonomensual, gastomensual, comentarioentrevistador, respuestas, 
                            candidato, nombre, apellidomaterno, apellidopaterno);
